...
let slider_about = new Swiper('.finishing-work__body', {
   /*
   effect: 'fade',
   autoplay: {
      delay: 3000,
...
let project_slider = new Swiper('.slider-project__body', {
   /*
   effect: 'fade',
   autoplay: {
      delay: 3000,
   ...
   */
   ...
   // Arrows
   navigation: {
      nextEl: '.slider-project__arrow_r',
      prevEl: '.slider-project__arrow_l',
   },
...
let portfolio_slider = new Swiper('.slider-portfolio__body', {
   /*
   effect: 'fade',
   autoplay: {
      delay: 3000,
   ...
   */
   ...
   // Arrows
   navigation: {
      nextEl: '.slider-portfolio__arrow_r',
      prevEl: '.slider-portfolio__arrow_l',
   },
...
let advantage_slider = new Swiper('.advantage__body_hidden', {
   /*
   effect: 'fade',
   autoplay: {
      delay: 3000,
...
let services = document.querySelector(".hidden");

document.addEventListener("mouseover", servicesPopap);

function servicesPopap(e) {
   if (e.target.closest(".bottom-header__link_services")) {
      services.classList.add("_active")
   }
   if (!e.target.closest(".bottom-header__body")) {
      services.classList.remove("_active")
   }
}

console.log(services.innerHTML);
